...
public class FaultBarrier {
    ...
    static {
        final ImmutableMap.Builder<Class<? extends Throwable>, StatusCode> builder = ImmutableMap.builder();
    ...
    /**
     * Request域取出对应错误信, 封装成实体ErrorEntity后转换成JSON输出
     *
    ...
    /**
     * Request域取出对应错误信息, 封装成实体ErrorEntity后转换成JSON输出
     *
